...
function [] = test_patch_generate_1024(name1)
    ...
    if ((tissue_region / (2048*2048) > 0.25) && (count_bg / (2048*2048) <0.7) && (row == 2048) && (col == 2048))    %check the ratio of total no of pixels in [512 * 512] image , to remove the background patches.     
        ...
        output_filename1 = strcat('/raid/data/home/matlab/Mousumi/dataset/1024/test/',sprintf('%s_%d_%d.tiff', filename, block_struct.location(1),block_struct.location(2)));
...
%         output_filename2 = strcat('K:\PAIP_Challenge\dataset\512\test\',sprintf('%s_%d_%d.tiff', filename, block_struct.location(1),block_struct.location(2)));
...
%         output_filename3 = strcat('K:\PAIP_Challenge\dataset\256\test\',sprintf('%s_%d_%d.tiff', filename, block_struct.location(1),block_struct.location(2)));
...
%         output_filename4 = strcat('K:\PAIP_Challenge\dataset\128\test\',sprintf('%s_%d_%d.tiff', filename, block_struct.location(1),block_struct.location(2)));
