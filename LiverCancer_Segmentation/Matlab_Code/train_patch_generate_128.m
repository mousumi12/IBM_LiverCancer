...
function [] = train_patch_generate_128(name1)
    ...
    if ((tissue_region / (256*256) > 0.25) && (count_bg / (256*256) <0.7) && (row == 256) && (col == 256))    %check the ratio of total no of pixels in [512 * 512] image , to remove the background patches.     
        ...
        output_filename1 = strcat('/raid/data/home/matlab/Mousumi/dataset/128/train/',sprintf('%s_%d_%d.tiff', filename, block_struct.location(1),block_struct.location(2)));
