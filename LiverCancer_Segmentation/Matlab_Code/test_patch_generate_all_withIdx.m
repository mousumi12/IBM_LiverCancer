...
function fun(block_struct)
    ...
    % carefully fix values here
        ...
        output_filename = strcat('/raid/data/home/matlab/Mousumi/Test_01_01_0113/Image_withIdx/',sprintf('%d_%d_%d.tiff', idx, block_struct.location(1),block_struct.location(2)));
