...
function fun(block_struct)
    ...
    % carefully fix values here
        ...
        output_filename = strcat('/raid/data/home/matlab/Mousumi/Test_01_01_0113/Image/',sprintf('%s_%d_%d.tiff', filename, block_struct.location(1),block_struct.location(2)));
