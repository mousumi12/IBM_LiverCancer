...
os.environ["CUDA_VISIBLE_DEVICES"]="1" #model will be trained on GPU 0
...
autoencoder_20x.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_20x_V3_200epoch_OverlapData.h5')
autoencoder_10x.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_10x_V3_200epoch_OverlapData.h5')
autoencoder_5x.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_5x_V3_200epoch_OverlapData.h5')
...
cp_cb = ModelCheckpoint(filepath = '../checkpoints/autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('../Figures/Train_Val_accuracy_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_OverlapData.png')
...
plt.legend()
#plt.show()
fig.savefig('../Figures/Train_Val_Loss_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_OverlapData.png')


full_model.load_weights('../checkpoints/autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_OverlapData.h5')
...
#f = open( '../txt/file_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_OverlapData.txt', 'a' )
...
#f = open( 'file_classification_bottleneck_HistoVAE_V2_withoutflatten_multiRes_300epoch_OverlapData.txt', 'a' )
