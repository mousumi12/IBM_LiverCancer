...
cp_cb = ModelCheckpoint(filepath = '../checkpoints/autoencoder_bottleneck_withoutflatten_10x_V3_MSESSIMMAEloss.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('Train_Val_Loss_reconst_bottleneck_withoutflatten_10x_V3_MSESSIMMAEloss.png')
#plt.show()
"""


# Show the reconstruction result from autoencoder
autoencoder.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_10x_V3_MSESSIMMAEloss.h5')

score = autoencoder.evaluate(test_data, test_data, verbose=1)
print(score)
f = open( 'file_recons_V2_withoutflatten_10x_V3_MSESSIMMAEloss.txt', 'a' )
...
def showOrigDec2(orig, dec, num=100):
    ...
    import scipy.misc
    n = num
    #resultDir = "Test_result_bottleneck_HistoVAE_V3_withoutflatten_10x_V3_300epoch_MSESSIMMAEloss/"
...
plt.legend()
fig.savefig('../Figures/Train_Val_accuracy_classification_10x_V3_MSESSIMMAEloss.png')
...
#f = open( 'file_classification_bottleneck_HistoVAE_V2_withoutflatten_10x_V3_200epoch_MSESSIMMAEloss.txt', 'a' )
