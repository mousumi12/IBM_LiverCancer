...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_bottleneck_withoutflatten_5x_V3_200epoch_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('Train_Val_Loss_reconst_bottleneck_withoutflatten_5x_V3_200epoch_OverlapData.png')
#plt.show()


# save the model
#autoencoder.save_weights('autoencoder_bottleneck.h5')


# Show the reconstruction result from autoencoder
autoencoder.load_weights('autoencoder_bottleneck_withoutflatten_5x_V3_200epoch_OverlapData.h5')

score = autoencoder.evaluate(test_data, test_data, verbose=1)
print(score)
f = open( 'file_recons_V2_withoutflatten_5x_V3_200epoch_OverlapData.txt', 'a' )
...
def showOrigDec2(orig, dec, num=100):
    ...
    import scipy.misc
    n = num
    resultDir = "Test_result_bottleneck_HistoVAE_V3_withoutflatten_5x_V3_200epoch_OverlapData/"
...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_10x_V3_200epoch.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('Train_Val_accuracy_classification_bottleneck_HistoVAE_V2_withoutflatten_10x_V3_200epoch.png')
...
plt.legend()
#plt.show()
fig.savefig('Train_Val_Loss_classification_bottleneck_HistoVAE_V2_withoutflatten_10x_V3_200epoch.png')
