...
# Load dataset
train_data = np.load('../datasets_Overlap/datasets_5x_train/full_x.npy')
train_labels = np.load('../datasets_Overlap/datasets_5x_train/full_y.npy')
val_data = np.load('../datasets_Overlap/datasets_5x_val/full_x.npy')
val_labels = np.load('../datasets_Overlap/datasets_5x_val/full_y.npy')
test_data = np.load('../datasets_Overlap/datasets_5x_test/full_x.npy')
test_labels = np.load('../datasets_Overlap/datasets_5x_test/full_y.npy')
...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_5x_V3_MSESSIMMAEloss_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('../Figures/Train_Val_Loss_reconst_5x_V3_MSESSIMMAEloss_OverlapData.png')
#plt.show()



# Show the reconstruction result from autoencoder
autoencoder.load_weights('autoencoder_5x_V3_MSESSIMMAEloss_OverlapData.h5')

score = autoencoder.evaluate(test_data, test_data, verbose=1)
print(score)
f = open( 'file_recons_5x_V3_MSESSIMMAEloss_OverlapData.txt', 'a' )
...
def showOrigDec2(orig, dec, num=100):
    ...
    import scipy.misc
    n = num
    resultDir = "Test_result_5x_V3_MSESSIMMAEloss_OverlapData/"
...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_classification_10x_V3_MSESSIMMAEloss.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('Train_Val_accuracy_classification_10x_V3_MSESSIMMAEloss.png')
...
plt.legend()
#plt.show()
fig.savefig('../Figures/Train_Val_Loss_classification_10x_V3_MSESSIMMAEloss.png')

##########################################################################

full_model.load_weights('autoencoder_classification_10x_V3_MSESSIMMAEloss.h5')
