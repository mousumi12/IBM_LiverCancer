...
train_data = np.load('../datasets_Overlap/datasets_20x_train/full_x.npy')
train_labels = np.load('../datasets_Overlap/datasets_20x_train/full_y.npy')
val_data = np.load('../datasets_Overlap/datasets_20x_val/full_x.npy')
val_labels = np.load('../datasets_Overlap/datasets_20x_val/full_y.npy')
test_data = np.load('../datasets_Overlap/datasets_20x_test/full_x.npy')
test_labels = np.load('../datasets_Overlap/datasets_20x_test/full_y.npy')
...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_20x_V3_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('../Figures/Train_Val_Loss_reconst_20x_V3_OverlapData.png')
#plt.show()
...
autoencoder.load_weights('autoencoder_20x_V3_OverlapData.h5')

score = autoencoder.evaluate(test_data, test_data, verbose=1)
print(score)
f = open( 'file_recons_20x_V3_OverlapData.txt', 'a' )
...
def showOrigDec2(orig, dec, num=100):
    ...
    import scipy.misc
    n = num
    resultDir = "Test_result_20x_V3_OverlapData/"
...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_classification_20x_V3.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('../Figures/Train_Val_accuracy_classification_20x_V3.png')
...
plt.legend()
#plt.show()
fig.savefig('../Figures/Train_Val_Loss_classification_20x_V3.png')

##############################################################

full_model.load_weights('autoencoder_classification_20x_V3.h5')

# Model Evaluation on the Test Set
test_eval = full_model.evaluate(test_data, test_Y_one_hot, verbose=0)
print('Test loss:', test_eval[0])
print('Test accuracy:', test_eval[1])
#f = open( 'file_classification_bottleneck_HistoVAE_V2_withoutflatten_20x_V3_200epoch.txt', 'a' )
