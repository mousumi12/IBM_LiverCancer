...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV2_300epoch_MSESSIMMAEloss_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('Train_Val_accuracy_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV2_300epoch_MSESSIMMAEloss_OverlapData.png')
...
plt.legend()
#plt.show()
fig.savefig('Train_Val_Loss_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV2_300epoch_MSESSIMMAEloss_OverlapData.png')


full_model.load_weights('autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV2_300epoch_MSESSIMMAEloss_OverlapData.h5')
...
f = open( 'file_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV2_300epoch_MSESSIMMAEloss_OverlapData.txt', 'a' )
