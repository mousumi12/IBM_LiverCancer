...
os.environ["CUDA_VISIBLE_DEVICES"]="6" #model will be trained on GPU 0
...
# 20x dataset
train_data_20x = np.load('datasets_Overlap/datasets_20x_train/full_x.npy')
train_labels_20x = np.load('datasets_Overlap/datasets_20x_train/full_y.npy')
val_data_20x = np.load('datasets_Overlap/datasets_20x_val/full_x.npy')
val_labels_20x = np.load('datasets_Overlap/datasets_20x_val/full_y.npy')
test_data_20x = np.load('datasets_Overlap/datasets_20x_test/full_x.npy')
test_labels_20x = np.load('datasets_Overlap/datasets_20x_test/full_y.npy')


# 10x dataset
train_data_10x = np.load('datasets_Overlap/datasets_10x_train/full_x.npy')
train_labels_10x = np.load('datasets_Overlap/datasets_10x_train/full_y.npy')
val_data_10x = np.load('datasets_Overlap/datasets_10x_val/full_x.npy')
val_labels_10x = np.load('datasets_Overlap/datasets_10x_val/full_y.npy')
test_data_10x = np.load('datasets_Overlap/datasets_10x_test/full_x.npy')
test_labels_10x = np.load('datasets_Overlap/datasets_10x_test/full_y.npy')

# 5x dataset
train_data_5x = np.load('datasets_Overlap/datasets_5x_train/full_x.npy')
train_labels_5x = np.load('datasets_Overlap/datasets_5x_train/full_y.npy')
val_data_5x = np.load('datasets_Overlap/datasets_5x_val/full_x.npy')
val_labels_5x = np.load('datasets_Overlap/datasets_5x_val/full_y.npy')
test_data_5x = np.load('datasets_Overlap/datasets_5x_test/full_x.npy')
test_labels_5x = np.load('datasets_Overlap/datasets_5x_test/full_y.npy')
...
autoencoder_20x.compile(loss=loss_mix, metrics=['mse'], optimizer = adam)
...
autoencoder_10x.compile(loss=loss_mix, metrics=['mse'], optimizer = adam)
...
autoencoder_5x.compile(loss=loss_mix, metrics=['mse'], optimizer = adam)
...
autoencoder_20x.load_weights('autoencoder_bottleneck_withoutflatten_20x_V3_300epoch_MSESSIMMAEloss_OverlapData.h5')
autoencoder_10x.load_weights('autoencoder_bottleneck_withoutflatten_10x_V3_300epoch_MSESSIMMAEloss_OverlapData.h5')
autoencoder_5x.load_weights('autoencoder_bottleneck_withoutflatten_5x_V3_300epoch_MSESSIMMAEloss_OverlapData.h5')
...
def fc(enco1, enco2, enco3):
    ...
    den = Dense(1024, activation='relu', kernel_regularizer=l2(0.01))(res)
    den = BatchNormalization()(den)
    den = Dropout(0.5)(den)
    #den = Dense(256, activation='relu', kernel_regularizer=l2(0.01))(den)
    #den = BatchNormalization()(den)
    #den = Dropout(0.3)(den)
    den = Dense(1024, activation='relu', kernel_regularizer=l2(0.01))(den)
    den = BatchNormalization()(den)
    den = Dropout(0.5)(den)
...
cp_cb = ModelCheckpoint(filepath = 'autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV3_300epoch_MSESSIMMAEloss_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
classify_train = full_model.fit([train_X_20x,train_X_10x,train_X_5x], train_label_20x, batch_size=64,epochs=300,verbose=1,callbacks=callbacks_list,validation_data=([valid_X_20x,valid_X_10x,valid_X_5x], valid_label_20x))
...
plt.legend()
fig.savefig('Train_Val_accuracy_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV3_300epoch_MSESSIMMAEloss_OverlapData.png')
...
plt.legend()
#plt.show()
fig.savefig('Train_Val_Loss_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV3_300epoch_MSESSIMMAEloss_OverlapData.png')


full_model.load_weights('autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV3_300epoch_MSESSIMMAEloss_OverlapData.h5')

# Model Evaluation on the Test Set
test_eval = full_model.evaluate([test_data_20x, test_data_10x,test_data_5x], test_Y_one_hot_20x, verbose=0)
print('Test loss:', test_eval[0])
print('Test accuracy:', test_eval[1])
f = open( 'file_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_FCV3_300epoch_MSESSIMMAEloss_OverlapData.txt', 'a' )
