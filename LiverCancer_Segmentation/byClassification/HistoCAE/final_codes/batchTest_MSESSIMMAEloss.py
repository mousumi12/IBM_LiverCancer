...
dirname_labelImage = '../Prediction_label_Images_Only10x_MSESSIMMAEloss/'
...
full_model.load_weights('../checkpoints/autoencoder_classification_10x_V3_MSESSIMMAEloss.h5')
