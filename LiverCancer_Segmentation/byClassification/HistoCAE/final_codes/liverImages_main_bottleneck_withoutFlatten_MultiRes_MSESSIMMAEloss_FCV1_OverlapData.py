...
autoencoder_20x.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_20x_V3_300epoch_MSESSIMMAEloss_OverlapData.h5')
autoencoder_10x.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_10x_V3_300epoch_MSESSIMMAEloss_OverlapData.h5')
autoencoder_5x.load_weights('../checkpoints/autoencoder_bottleneck_withoutflatten_5x_V3_300epoch_MSESSIMMAEloss_OverlapData.h5')
...
def fc(enco1, enco2, enco3):
    ...
    den = Dense(256, activation='relu', kernel_regularizer=l2(0.01))(res)
...
cp_cb = ModelCheckpoint(filepath = '../checkpoints/autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_MSESSIMMAEloss_OverlapData.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto')
...
plt.legend()
fig.savefig('../Figures/Train_Val_accuracy_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_MSESSIMMAEloss_OverlapData.png')
...
plt.legend()
#plt.show()
fig.savefig('../Figures/Train_Val_Loss_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_MSESSIMMAEloss_OverlapData.png')

full_model.load_weights('../checkpoints/autoencoder_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_MSESSIMMAEloss_OverlapData.h5')

# Model Evaluation on the Test Set
test_eval = full_model.evaluate([test_data_20x, test_data_10x,test_data_5x], test_Y_one_hot_20x, verbose=0)
print('Test loss:', test_eval[0])
print('Test accuracy:', test_eval[1])
#f = open( 'file_classification_bottleneck_HistoVAE_V2_withoutflatten_MultiRes_300epoch_MSESSIMMAEloss_OverlapData.txt', 'a' )
