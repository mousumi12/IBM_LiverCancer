...
from utils import VIS, mean_IU, dice_coef, dice_coef_loss
...
with sess.as_default():
    ...
    for it in range(0, test_samples):
        ...
        score, cls_score = vis.add_sample(pred_map, y_batch[0])
        #dice_coeff = dice_coef(y_batch[0], pred_map)
        #dice_loss = dice_coef_loss(y_batch[0], pred_map)
